# Generated by Django 4.2.25 on 2025-10-16 15:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('svg_id', models.CharField(help_text="Unique ID matching the SVG element in the floor plan (e.g., 'desk-a1-svg')", max_length=50, unique=True)),
                ('svg_shape', models.CharField(choices=[('rect', 'Rectangle')], max_length=10)),
